...
type ScrapedGenreAnime = Pick<ScrapedAnimeCategory, CommonAnimeScrapeTypes | 'genres'> &
  Pick<ScrapedHomePage, 'topAiringAnimes'> & {
    genreName: string
  }
...
declare namespace hianime {
  export {
    type hianime_AZListSortOptions as AZListSortOptions,
    hianime_AZ_LIST_SORT_OPTIONS as AZ_LIST_SORT_OPTIONS,
    ...
    hianime_SEARCH_PAGE_FILTERS as SEARCH_PAGE_FILTERS,
    type hianime_ScrapedAnimeAZList as ScrapedAnimeAZList,
    ...
    type hianime_ScrapedAnimeQtipInfo as ScrapedAnimeQtipInfo,
    ...
    type hianime_ScrapedNextEpisodeSchedule as ScrapedNextEpisodeSchedule,
